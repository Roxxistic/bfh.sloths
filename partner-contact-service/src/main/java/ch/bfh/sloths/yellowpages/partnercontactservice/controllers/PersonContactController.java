...
import ch.bfh.sloths.yellowpages.partnercontactservice.clients.AddressClient;
import ch.bfh.sloths.yellowpages.partnercontactservice.clients.PersonClient;
...
public class PersonContactController implements ResourceProcessor<RepositoryLinksResource> {
    ...
    public Resource<PersonContact> getPersonContact(@PathVariable("id") String id){
        ...
        Collection<Address> addresses = addressClient.getAddressesForPerson(person.getId()).getContent();
    ...
    public Resources<PersonContact> getPersonContacts(){
        ...
        for(Person person : persons){
            ...
            personContact.setFirstName(person.getFirstName());
            personContact.setLastName(person.getLastName());
            personContact.setAddresses(addressClient.getAddressesForPerson(person.getId()).getContent());
